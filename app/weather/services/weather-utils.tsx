...
type ThemeColors = { light: [string, string, string]; dark: [string, string, string]; glow: string };

const WX_THEME: Record<string, ThemeColors> = {
  "clear-day":   { light: ["#FFF6E3", "#FDE7C2", "#FAD9F0"], dark: ["#1B2233", "#241F33", "#2A2436"], glow: "#F7B733" },
  "partly-day":  { light: ["#F2F7FF", "#E6EEFA", "#FBEFD9"], dark: ["#161E2E", "#1C2336", "#23283A"], glow: "#7FB2F0" },
  "cloudy":      { light: ["#F4F6FA", "#E8ECF3", "#DEE3EC"], dark: ["#16181F", "#1B1E27", "#212530"], glow: "#9AA6BC" },
  "fog":         { light: ["#F1F3F6", "#E5E9EF", "#DADFE7"], dark: ["#15171C", "#1A1D24", "#1F232B"], glow: "#AEB7C7" },
  "drizzle":     { light: ["#EEF5FC", "#DFEBF7", "#D2E3F2"], dark: ["#121821", "#16202D", "#1B2735"], glow: "#5FA8E8" },
  "rain":        { light: ["#E9F1F9", "#D6E5F2", "#C4D8EC"], dark: ["#0F151E", "#131D29", "#172534"], glow: "#4F9BE6" },
  "snow":        { light: ["#F3F8FC", "#E6F0F8", "#DCEAF5"], dark: ["#13181F", "#181F28", "#1D2733"], glow: "#BcdcF5" },
  "thunder":     { light: ["#F0EEF7", "#E2DEF0", "#D8D2EC"], dark: ["#16141F", "#1B1826", "#211C30"], glow: "#9B7BE0" },
  "clear-night": { light: ["#EDF1FA", "#E2E8F5", "#D8DFF0"], dark: ["#0E1320", "#12172A", "#171C33"], glow: "#5B6CC0" },
  "partly-night":{ light: ["#EDF1FA", "#E2E8F5", "#D8DFF0"], dark: ["#0E1320", "#12172A", "#171C33"], glow: "#5B6CC0" },
};

export function getWeatherBackground(conditionKey: string, isDark: boolean): string {
